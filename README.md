...
```sh
export GITHUB_TOKEN=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
export GITHUB_USER=mueroema
export GITHUB_REPO=https://github.com/mueroema/flux2-kustomize-helm-example
```
